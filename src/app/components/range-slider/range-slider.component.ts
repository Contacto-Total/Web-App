...
import { CampañaService } from '../../services/campaña/campaña.service';

import Swal from 'sweetalert2';
import { Router } from '@angular/router';
import { CampañaYReporteRequest } from '../../model/rango.model';
...
export class RangeSliderComponent implements OnInit{
  ...
  constructor(private router: Router, private messageService: MessageService, private campañaService: CampañaService) {}
  ...
  printRanges() {
    ...
    const campañaYReporteRequest: CampañaYReporteRequest = {
      contactoDirectoRangos: contactoDirectoRangesToConsult,
      contactoIndirectoRangos: contactoIndirectoRangesToConsult,
      promesasRotasRangos: promesasRotasRangesToConsult,
      noContactadoRangos: noContactadoRangesToConsult
    };
