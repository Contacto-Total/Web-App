...
import { GenerateMessagesRequest, PlantillaResponse } from '../../model/plantilla.model';
...
export class SmsTemplatesComponent implements OnInit{
  ...
  selectedTemplate: PlantillaResponse | null = null;
  ...
  updateTemplate(plantilla: PlantillaResponse): void {
