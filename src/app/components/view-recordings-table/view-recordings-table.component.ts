...
import { GestionHistoricaAudiosService } from '../../services/gestion-historica-audios/gestion-historica-audios.service';
import { FtpService } from '../../services/ftp/ftp.service';
import { DownloadHistoricoAudioRequest } from '../../model/ftp.model';
import { AudioEvaluacionService } from '../../services/audio-evaluacion/audio-evaluacion.service';
import { CreateAudioEvaluacionFileRequest } from '../../model/audio-evaluacion.model';

import Swal from 'sweetalert2';
import { DocumentoRequest, TelefonoRequest } from '../../model/gestion-historica-audios.model';

@Component({
  selector: 'app-view-recordings-table',
  standalone: true,
  ...
  templateUrl: './view-recordings-table.component.html',
  styleUrl: './view-recordings-table.component.css',
  providers: [MessageService]
})
export class ViewRecordingsTableComponent implements OnInit {
  ...
  constructor(private gestionHistoricaAudiosService: GestionHistoricaAudiosService, private ftpService: FtpService, private audioEvaluacionService: AudioEvaluacionService, private primengConfig: PrimeNGConfig, private messageService: MessageService) {}
  ...
  searchByTelefono() {
    ...
    const telefonoRequest: TelefonoRequest = {
  ...
  downloadAudio(gestion: any) {
    ...
    for (let i = 0; i < anio_chain.length; i++) {
      ...
      const downloadHistoricoAudioRequest: DownloadHistoricoAudioRequest = {
        anio: anio_chain[i],
        mes: mes_chain[i],
        dia: dia_chain[i],
  ...
  downloadReport(gestion: any) {
    const createAudioEvaluacionFileRequest: CreateAudioEvaluacionFileRequest = {
  ...
  massiveDownloadAudios() {
    ...
    const downloadHistoricoAudioRequests: DownloadHistoricoAudioRequest[] = [];
  ...
  massiveDownloadReports() {
    ...
    const createAudioEvaluacionFileRequests: CreateAudioEvaluacionFileRequest[] = [];
