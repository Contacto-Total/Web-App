...
@Component({
  ...
  templateUrl: './update-sms-template-form.component.html',
  styleUrl: './update-sms-template-form.component.css',
  providers: [MessageService]
})
export class UpdateSmsTemplateFormComponent implements OnInit{
  ...
  onSubmit() {
    ...
    if (this.templateName && this.templateContent) {
      const plantillaToUpdate: UpdateTemplateRequest = {
        id: this.template.id,
